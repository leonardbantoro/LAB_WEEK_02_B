...
class MainActivity : AppCompatActivity() {
    companion object {
        ...
        private const val ERROR_KEY = "ERROR_KEY"  // add this since you use ERROR_KEY later
    }

    private val submitButton: Button
        get() = findViewById(R.id.submit_button)

    private val startForResult = registerForActivityResult(ActivityResultContracts.StartActivityForResult()) { activityResult: ActivityResult ->
